...
Route::prefix('admin')->name('admin.')->middleware(['auth', LogUserActivity::class])->group(function () {
    ...
    Route::get('fab-faqs', [FabFaqItemController::class, 'index'])->middleware('permission:appearance.view')->name('fab-faqs.index');
    Route::get('fab-faqs/create', [FabFaqItemController::class, 'create'])->middleware('permission:appearance.update')->name('fab-faqs.create');
    Route::post('fab-faqs', [FabFaqItemController::class, 'store'])->middleware('permission:appearance.update')->name('fab-faqs.store');
    Route::get('fab-faqs/{fabFaq}/edit', [FabFaqItemController::class, 'edit'])->middleware('permission:appearance.update')->name('fab-faqs.edit');
    Route::put('fab-faqs/{fabFaq}', [FabFaqItemController::class, 'update'])->middleware('permission:appearance.update')->name('fab-faqs.update');
    Route::delete('fab-faqs/{fabFaq}', [FabFaqItemController::class, 'destroy'])->middleware('permission:appearance.update')->name('fab-faqs.destroy');
    Route::post('fab-faqs/{fabFaq}/move', [FabFaqItemController::class, 'move'])->middleware('permission:appearance.update')->name('fab-faqs.move');
    ...
    Route::get('users/import-template', [UserController::class, 'downloadImportTemplate'])->middleware('permission:users.create')->name('users.import-template');
    Route::post('users/import', [UserController::class, 'import'])->middleware('permission:users.create')->name('users.import');
    Route::get('users/import-results/{report}', [UserController::class, 'downloadImportReport'])->middleware('permission:users.create')->name('users.import-results');
    ...
    Route::get('organizations/import-report/{report}', [ManagedResourceController::class, 'downloadOrganizationImportReport'])
        ->middleware('permission:organizations.view')
        ->name('organizations.import-report');
    ...
    Route::get('training-organizers/export', [ManagedResourceController::class, 'exportTrainingOrganizers'])
        ->middleware('permission:training_organizers.view')
        ->name('training-organizers.export');

    Route::post('training-organizers/import', [ManagedResourceController::class, 'importTrainingOrganizers'])
