...
class SidebarMenuSeeder extends Seeder
{
    ...
    private function items(): array
    {
        return [
            ...
            ['key' => 'appearance_fab_faqs', 'title' => 'FAB FAQs', 'section_key' => 'settings', 'parent_key' => 'appearance_root', 'icon' => null, 'route_name' => 'admin.fab-faqs.index', 'url' => null, 'target' => '_self', 'required_permission' => 'appearance.view', 'sort_order' => 50, 'is_active' => true],
            ['key' => 'appearance_env', 'title' => 'Env Settings', 'section_key' => 'settings', 'parent_key' => 'appearance_root', 'icon' => null, 'route_name' => 'admin.settings.env.edit', 'url' => null, 'target' => '_self', 'required_permission' => 'appearance.view', 'sort_order' => 60, 'is_active' => true],
