...
return new class extends Migration
{
    ...
    private function itemMetadata(string $title): array
    {
        $metadata = [
            ...
            'How do I register as a participant?' => ['visibility' => 'public', 'link_label' => 'Open registration', 'link_url' => '/hil2/participant-registration'],
            'What happens if my generated participant ID already exists?' => ['visibility' => 'public', 'link_label' => 'Open registration', 'link_url' => '/hil2/participant-registration'],
            'Can I join a training event from the public website?' => ['visibility' => 'public', 'link_label' => 'Request enrollment', 'link_url' => '/hil2/training-event-join-request'],
            'Can admins search existing participants during enrollment?' => ['visibility' => 'admin', 'link_label' => 'Create participant', 'link_url' => '/hil2/admin/participants/create'],
            'Can participant training participation be exported?' => ['visibility' => 'admin', 'link_label' => 'Export participation', 'link_url' => '/hil2/admin/participants/training-participation/export'],
            'What does the training calendar show by default?' => ['visibility' => 'public', 'link_label' => 'Open calendar', 'link_url' => '/hil2/embed/training-events-calendar'],
            'How are grouped training events displayed?' => ['visibility' => 'admin', 'link_label' => 'Open grouped training', 'link_url' => '/hil2/admin/training-events/grouped-training'],
            'Can I edit events from grouped views?' => ['visibility' => 'admin', 'link_label' => 'Open grouped events', 'link_url' => '/hil2/admin/training-events/grouped'],
            'What is the training workflow used for?' => ['visibility' => 'admin', 'link_label' => 'Open workflow', 'link_url' => '/hil2/admin/training-workflow'],
            'What can admins do in Step 5 Closeout?' => ['visibility' => 'admin', 'link_label' => 'Open closeout', 'link_url' => '/hil2/admin/training-workflow?step=5'],
            'Can event pictures be uploaded in bulk?' => ['visibility' => 'admin', 'link_label' => 'Open closeout', 'link_url' => '/hil2/admin/training-workflow?step=5'],
            'How are final scores calculated?' => ['visibility' => 'admin', 'link_label' => 'Open workflow', 'link_url' => '/hil2/admin/training-workflow?step=4'],
            'Can workshop score sheets be imported or exported?' => ['visibility' => 'admin', 'link_label' => 'Open scores', 'link_url' => '/hil2/admin/training-workflow?step=4'],
            'What reports are available for training participation?' => ['visibility' => 'admin', 'link_label' => 'Open participants', 'link_url' => '/hil2/admin/participants'],
            'Can dashboards be shared?' => ['visibility' => 'admin', 'link_label' => 'Open dashboard', 'link_url' => '/hil2/admin'],
            'Can admins import users?' => ['visibility' => 'admin', 'link_label' => 'Open users', 'link_url' => '/hil2/admin/users'],
            'How are temporary passwords shared?' => ['visibility' => 'admin', 'link_label' => 'Open users', 'link_url' => '/hil2/admin/users'],
            'How are roles assigned?' => ['visibility' => 'admin', 'link_label' => 'Open roles', 'link_url' => '/hil2/admin/roles'],
            'How do I enable the floating FAQ chatbot?' => ['visibility' => 'admin', 'link_label' => 'Open appearance', 'link_url' => '/hil2/admin/appearance'],
            'How do I manage chatbot FAQ content?' => ['visibility' => 'admin', 'link_label' => 'Manage FAQs', 'link_url' => '/hil2/admin/fab-faqs'],
            'Can FAQs have more than one level?' => ['visibility' => 'admin', 'link_label' => 'Manage FAQs', 'link_url' => '/hil2/admin/fab-faqs'],
            'Can organization data be imported?' => ['visibility' => 'admin', 'link_label' => 'Open organizations', 'link_url' => '/hil2/admin/organizations'],
            'Can participant data be imported?' => ['visibility' => 'admin', 'link_label' => 'Open participants', 'link_url' => '/hil2/admin/participants'],
            'Does the system expose API documentation?' => ['visibility' => 'admin', 'link_label' => 'Open API docs', 'link_url' => '/hil2/admin/api-management/docs'],
            'Can training event data be synced to DHIS2?' => ['visibility' => 'admin', 'link_label' => 'Open API management', 'link_url' => '/hil2/admin/api-management'],
            'Can admins manage website pages?' => ['visibility' => 'admin', 'link_label' => 'Open pages', 'link_url' => '/hil2/admin/pages'],
            'Can the public website menu be managed from admin?' => ['visibility' => 'admin', 'link_label' => 'Open menus', 'link_url' => '/hil2/admin/menus'],
            'Can the admin sidebar menu be customized?' => ['visibility' => 'admin', 'link_label' => 'Open sidebar menus', 'link_url' => '/hil2/admin/sidebar-menus'],
            'What can be changed from Appearance settings?' => ['visibility' => 'admin', 'link_label' => 'Open appearance', 'link_url' => '/hil2/admin/appearance'],
            'Can custom CSS and JavaScript be added?' => ['visibility' => 'admin', 'link_label' => 'Open appearance', 'link_url' => '/hil2/admin/appearance'],
            'Can the public login page be branded?' => ['visibility' => 'admin', 'link_label' => 'Open appearance', 'link_url' => '/hil2/admin/appearance'],
            'What project information can be tracked?' => ['visibility' => 'admin', 'link_label' => 'Open projects', 'link_url' => '/hil2/admin/projects'],
            'Can project categories be managed?' => ['visibility' => 'admin', 'link_label' => 'Open project categories', 'link_url' => '/hil2/admin/project-categories'],
            'Can participant projects be linked?' => ['visibility' => 'admin', 'link_label' => 'Open projects', 'link_url' => '/hil2/admin/projects'],
            'Can training materials be uploaded?' => ['visibility' => 'admin', 'link_label' => 'Open materials', 'link_url' => '/hil2/admin/trainingmaterials'],
            'Can training materials use external links?' => ['visibility' => 'admin', 'link_label' => 'Open materials', 'link_url' => '/hil2/admin/trainingmaterials'],
            'Can materials be ordered or hidden?' => ['visibility' => 'admin', 'link_label' => 'Open materials', 'link_url' => '/hil2/admin/trainingmaterials'],
            'What location data does the system manage?' => ['visibility' => 'admin', 'link_label' => 'Open regions', 'link_url' => '/hil2/admin/regions'],
            'How are organizations connected to locations?' => ['visibility' => 'admin', 'link_label' => 'Open organizations', 'link_url' => '/hil2/admin/organizations'],
            'Can imported location IDs be preserved?' => ['visibility' => 'admin', 'link_label' => 'Open organizations', 'link_url' => '/hil2/admin/organizations'],
            'What is the difference between Trainings and Training Events?' => ['visibility' => 'admin', 'link_label' => 'Open trainings', 'link_url' => '/hil2/admin/trainings'],
            'Can training categories be managed?' => ['visibility' => 'admin', 'link_label' => 'Open training categories', 'link_url' => '/hil2/admin/trainingcategories'],
            'Can professions be managed?' => ['visibility' => 'admin', 'link_label' => 'Open professions', 'link_url' => '/hil2/admin/professions'],
            'Can admins review user activity?' => ['visibility' => 'admin', 'link_label' => 'Open activity logs', 'link_url' => '/hil2/admin/user-activity-logs'],
            'Why was the activity log query optimized?' => ['visibility' => 'admin', 'link_label' => 'Open activity logs', 'link_url' => '/hil2/admin/user-activity-logs'],
            'Can environment settings be managed from admin?' => ['visibility' => 'admin', 'link_label' => 'Open env settings', 'link_url' => '/hil2/admin/settings/env'],
            'What is API Management used for?' => ['visibility' => 'admin', 'link_label' => 'Open API management', 'link_url' => '/hil2/admin/api-management'],
            'Who can access system administration features?' => ['visibility' => 'admin', 'link_label' => 'Open roles', 'link_url' => '/hil2/admin/roles'],
        ];
