        ...
        <aside class="admin-sidebar px-3 py-4 sidebar">
            ...
            @else
                ...
                <nav class="d-grid gap-1 mb-4">
                    ...
                    @if($user?->hasPermission('appearance.view'))<a class="{{ request()->routeIs('admin.fab-faqs.*') ? 'active' : '' }}" href="{{ route('admin.fab-faqs.index') }}" title="FAB FAQs" aria-label="FAB FAQs"><i class="bi bi-chat-dots menu-icon" aria-hidden="true"></i><span class="sidebar-label">FAB FAQs</span></a>@endif
