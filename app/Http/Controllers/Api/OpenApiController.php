        ...
        return [
            ...
            'Participant' => [
                ...
                'properties' => [
                    ...
                    'date_of_birth' => ['type' => 'string', 'format' => 'date', 'nullable' => true, 'description' => 'Must not be in the future.'],
                    'age' => ['type' => 'integer', 'nullable' => true, 'minimum' => 0, 'maximum' => 120],
                    'gender' => ['type' => 'string', 'enum' => ['male', 'female']],
                    'home_phone' => ['type' => 'string', 'nullable' => true, 'maxLength' => 30, 'pattern' => '^(?=(?:\D*\d){7,15}\D*$)\+?\d[\d\s().-]*\d$'],
                    'mobile_phone' => ['type' => 'string', 'maxLength' => 30, 'pattern' => '^(?=(?:\D*\d){7,15}\D*$)\+?\d[\d\s().-]*\d$'],
            ...
            'TrainingOrganizerWrite' => [
                ...
                'properties' => [
                    ...
                    'project_long_name' => ['type' => 'string', 'nullable' => true, 'maxLength' => 255],
                    'donor' => ['type' => 'string', 'nullable' => true, 'maxLength' => 255],
                    'program' => [
                        'type' => 'string',
                        'nullable' => true,
                        'maxLength' => 255,
